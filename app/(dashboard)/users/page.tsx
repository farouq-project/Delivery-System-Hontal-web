...
export default function UsersPage() {
  ...
  return (
    <div className="p-4 md:p-6">
      ...
      {(authUser?.role === 'owner' || authUser?.role === 'merchant_owner') && (
        <div className="bg-blue-50 border border-blue-200 rounded-lg px-4 py-3 mb-6 flex items-center justify-between gap-4">
          <div>
            <p className="text-sm font-medium text-blue-800">Depot GPS &amp; Driver App settings have moved</p>
            <p className="text-xs text-blue-600 mt-0.5">Configure depot address, GPS coordinates, hide-logout, and order PIN in Settings → Operational</p>
          </div>
          <Link href="/settings">
            <Button variant="outline" size="sm" className="shrink-0">Settings → Operational</Button>
          </Link>
        </div>
      )}
