              ...
              <table className="w-full text-sm">
                <thead className="bg-gray-50">
                  <tr className="border-b border-gray-200">
                    ...
                    <th className="px-4 py-3 text-left text-xs font-bold text-gray-700">Area / Cluster</th>
                    ...
                    <th className="px-4 py-3 text-right text-xs font-bold text-gray-700">Delivered</th>
                ...
                <tbody className="divide-y divide-gray-100">
                  {areas.map((row, i) => (
                    <tr key={String(row.cluster)} className="hover:bg-gray-50">
                      ...
                      <td className="px-4 py-3 text-right text-gray-800">{fmtNum(Number(row.delivered))}</td>
                      ...
                      <td className="px-4 py-3 text-right text-gray-800">{fmtNum(Number(row.unique_customers))}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
